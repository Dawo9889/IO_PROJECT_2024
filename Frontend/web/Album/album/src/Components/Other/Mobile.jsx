...
<div className='bg-project-dark-bg rounded-2xl shadow-2xl max-w-full lg:max-w-4/5 p-4 h-full overflow-y-auto'>
        <div className="mb-8 text-center">
            ...
            <a href="https://expo.dev/accounts/skinnyhand/projects/cupid-alpha/builds/78cc1eb1-7a70-41de-a485-0de656e6fe8e" className="mt-4 inline-block bg-project-blue px-6 py-2 rounded-lg shadow-md hover:bg-project-blue-buttons">Download the latest version</a>
        </div>
