...
function MyAlbum() {
    ...
    const handleWeddingSelect = (weddingId, weddingName) => {
            ...
            {!isStaticView ? ( // Jeśli dynamiczny widok
                <div style={{ display: "flex" }}>
                    <div className="upload-box-container">
                        <ImageGallery onDragStart={handleDragStart} onWeddingSelect={handleWeddingSelect} />
                    </div>
                    <div style={{ flex: 1 }}>
                        <HTMLFlipBook
                            key={bookKey}
