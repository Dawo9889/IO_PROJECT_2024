...
function MyAlbum() {
    ...
    const [pages, setPages] = useState([
        { id: 1, header: "Nag³ówek strony 1", imageLeft: null, imageLeftBottom: null },
        { id: 2, header: "Nag³ówek strony 2", imageLeft: null, imageLeftBottom: null },
    ]);
    ...
    const addPage = () => {
        const newPage = {
            id: pages.length + 1,
            header: `Nag³ówek strony ${pages.length + 1}`,
            imageLeft: null,
    ...
    return (
        <div style={{ backgroundColor: "LightCyan", minHeight: "100vh", padding: "20px", display: "flex" }}>
            <div className="upload-box-container">
                ...
                >
                    <span className="upload-text">Dodaj zdjêcie po lewej stronie</span>
                </div>
                <div
                    className="upload-box"
                    ...
                    onDragOver={(e) => e.preventDefault()}
                >
                    <span className="upload-text">Dodaj zdjêcie poni¿ej po lewej stronie</span>
                </div>

                <div className="page-select">
                    <label>Wybierz stronê do dodania zdjêcia:</label>
                    <input
                        type="number"
                        min="1"
                        max={pages.length}
            ...
            <div style={{ flex: 1 }}>
                ...
                <div className="formContainer">
                    <input
                        ...
                        type="text"
                        placeholder="Nowy nag³ówek strony"
                    />
                    <input
                        className="form-control"
                        type="number"
